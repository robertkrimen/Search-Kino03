# This Makefile is for the Search::Kino030 extension to perl.
#
...
#     ABSTRACT => q[The great new Search::Kino030!]
#     AUTHOR => q[Robert Krimen <rkrimen@cpan.org>]
#     DIR => []
#     DISTNAME => q[Search-Kino030]
#     NAME => q[Search::Kino030]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], ExtUtils::MakeMaker=>q[6.50], KinoSearch=>q[0.30_01] }
#     VERSION => q[0.01]
#     dist => {  }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Search/Kino030.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Search
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Search
...
TO_INST_PM = lib/Search/Kino030.pm

PM_TO_BLIB = lib/Search/Kino030.pm \
	blib/lib/Search/Kino030.pm
...
DISTNAME = Search-Kino030
DISTVNAME = Search-Kino030-0.01
...
manifypods : pure_all  \
	lib/Search/Kino030.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Search/Kino030.pm $(INST_MAN3DIR)/Search::Kino030.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Search::Kino030!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Robert Krimen &lt;rkrimen@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="ExtUtils-MakeMaker" VERSION="6,50,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="KinoSearch" VERSION="0,30_01,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Search/Kino030.pm blib/lib/Search/Kino030.pm 
...
# End.
# Postamble by Module::Install 0.79
...
installdeps ::
	$(PERL) Makefile.PL --config= --installdeps=KinoSearch,0.30_01
