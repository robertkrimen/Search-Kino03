...
use Search::Kino03::KinoSearch::Util::IndexFileNames qw( latest_snapshot );

Search::Kino03::KinoSearch::Store::Lock::set_commit_lock_timeout(100);
...
SKIP: {
    ...
    eval {
        $reader = Search::Kino03::KinoSearch::Index::IndexReader->open(
            index        => $folder,
...
Test_race_condition_1: {
    ...
    Search::Kino03::KinoSearch::Index::IndexReader::set_race_condition_debug1(
        Search::Kino03::KinoSearch::Util::CharBuf->new($latest_snapshot_file) );
    ...
    is( Search::Kino03::KinoSearch::Index::IndexReader::debug1_num_passes(),
    ...
    Search::Kino03::KinoSearch::Index::IndexReader::set_race_condition_debug1(undef);
...
$lock_factory = Search::Kino03::KinoSearch::Store::LockFactory->new(
    agent_id => 'me',
    folder   => $folder,
);
