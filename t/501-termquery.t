...
my $term_query
    = Search::Kino03::KinoSearch::Search::TermQuery->new( field => 'content', term => 'c' );
...
my $different_term = Search::Kino03::KinoSearch::Search::TermQuery->new(
    field => 'content',
    term  => 'd'
);
my $different_field = Search::Kino03::KinoSearch::Search::TermQuery->new(
    field => 'title',
    term  => 'c'
);
