...
my $no_field_leaf_query = Search::Kino03::KinoSearch::Search::LeafQuery->new( text => 'b' );
...
my $diff_field
    = Search::Kino03::KinoSearch::Search::LeafQuery->new( field => 'oink', text => 'b' );
ok( !$diff_field->equals($leaf_query), "!equals (different field)" );

my $diff_text
    = Search::Kino03::KinoSearch::Search::LeafQuery->new( field => 'content', text => 'c' );
