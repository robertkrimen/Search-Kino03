...
use Search::Kino03::KSx::Search::Filter;
...
my ( $filter_1, $filter_2 );
{
    ...
    my $searcher_1 = Search::Kino03::KinoSearch::Searcher->new( index => $folder_1 );
    my $searcher_2 = Search::Kino03::KinoSearch::Searcher->new( index => $folder_2 );

    my $reader_1 = $searcher_1->get_reader->get_seg_readers->[0];
    my $reader_2 = $searcher_2->get_reader->get_seg_readers->[0];

    my $only_a_query = Search::Kino03::KinoSearch::Search::TermQuery->new(
        field => 'content',
        term  => 'a',
    );
    $filter_1 = Search::Kino03::KSx::Search::Filter->new( query => $only_a_query );
    $filter_2 = Search::Kino03::KSx::Search::Filter->new( query => $only_a_query );
...
sub filt_query {
    ...
    return Search::Kino03::KinoSearch::Search::ANDQuery->new(
