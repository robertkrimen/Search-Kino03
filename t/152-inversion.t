...
use Search::Kino03::KinoSearch::Test::TestUtils qw( utf8_test_strings );

my $inversion = Search::Kino03::KinoSearch::Analysis::Inversion->new;
$inversion->append(
...
$inversion = Search::Kino03::KinoSearch::Analysis::Inversion->new;
$inversion->append(
    Search::Kino03::KinoSearch::Analysis::Token->new(
        text         => "foo",
        start_offset => 0,
...
$inversion = Search::Kino03::KinoSearch::Analysis::Inversion->new( text => $smiley );
is( $inversion->next->get_text,
    $smiley, "Inversion->new handles UTF-8 correctly" );
$inversion = Search::Kino03::KinoSearch::Analysis::Inversion->new( text => $not_a_smiley );
is( $inversion->next->get_text,
