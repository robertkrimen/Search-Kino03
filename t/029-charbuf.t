...
use Search::Kino03::KinoSearch::Test::Util::TestCharBuf qw( vcatf_tests );
...
isa_ok( $charbuf, "Search::Kino03::KinoSearch::Util::CharBuf" );
...
isa_ok( $dupe, "Search::Kino03::KinoSearch::Util::CharBuf",
...
my $deserialized = Search::Kino03::KinoSearch::Util::CharBuf->deserialize($instream);
