...
for my $conjunction (qw( AND OR )) {
    my $class = "Search::Kino03::KinoSearch::Search::${conjunction}Query";
    ...
    isa_ok( $compiler, "Search::Kino03::KinoSearch::Search::${conjunction}Compiler",
        "make_compiler" );
    ...
    isa_ok(
        $matcher,
        "Search::Kino03::KinoSearch::Search::${conjunction}Scorer",
    ...
    my $doomed_query = Search::Kino03::KinoSearch::Search::TermQuery->new(
        field => 'luckless',
        term  => 'zero',
    );
    $polyquery
