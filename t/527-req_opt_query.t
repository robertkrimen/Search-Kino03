...
my $x_query = Search::Kino03::KinoSearch::Search::TermQuery->new(
    field => 'content',
    term  => 'x'
);

my $req_opt_query = Search::Kino03::KinoSearch::Search::RequiredOptionalQuery->new(
...
isa_ok( $matcher, 'Search::Kino03::KinoSearch::Search::RequiredOptionalScorer' );

$req_opt_query = Search::Kino03::KinoSearch::Search::RequiredOptionalQuery->new(
    required_query => $b_query,
