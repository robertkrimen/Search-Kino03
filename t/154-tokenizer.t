...
my $other       = Search::Kino03::KinoSearch::Analysis::Tokenizer->new( pattern => '\w+' );
my $yet_another = Search::Kino03::KinoSearch::Analysis::Tokenizer->new( pattern => '\w+' );
...
my $inversion = Search::Kino03::KinoSearch::Analysis::Inversion->new( text => "a b c" );
...
$tokenizer = Search::Kino03::KinoSearch::Analysis::Tokenizer->new( pattern => '.' );
$inversion = Search::Kino03::KinoSearch::Analysis::Inversion->new( text    => "a b c" );
$inversion = $tokenizer->transform($inversion);
...
$tokenizer = Search::Kino03::KinoSearch::Analysis::Tokenizer->new( token_re => qr/../ );
