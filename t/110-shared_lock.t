...
my $lock = Search::Kino03::KinoSearch::Store::SharedLock->new(
    folder    => $folder,
    lock_name => 'ness',
    timeout   => 0,
    agent_id  => 'nessie',
...
my $another_lock = Search::Kino03::KinoSearch::Store::SharedLock->new(
    folder    => $folder,
    lock_name => 'ness',
    timeout   => 0,
    agent_id  => 'nessie',
...
my $ya_lock = Search::Kino03::KinoSearch::Store::SharedLock->new(
    folder    => $folder,
    lock_name => 'ness',
    timeout   => 0,
    agent_id  => 'nessie',
