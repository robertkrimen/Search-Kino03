...
my $schema2 = Search::Kino03::KinoSearch::Test::TestSchema->new;
my $folder2 = Search::Kino03::KinoSearch::Store::RAMFolder->new;
$schema2->spec_field( name => 'foo', type => $type );
my $indexer2 = Search::Kino03::KinoSearch::Indexer->new(
    schema => $schema2,
    index  => $folder2,
);
