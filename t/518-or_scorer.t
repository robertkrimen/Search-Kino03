...
sub check_scorer {
    ...
    my $subscorers
        = Search::Kino03::KinoSearch::Util::VArray->new( capacity => scalar @intervals );
    for my $doc_id_array (@doc_id_arrays) {
        my $mock = Search::Kino03::KSx::Search::MockScorer->new(
    ...
    my $or_scorer = Search::Kino03::KinoSearch::Search::ORScorer->new(
        similarity => $sim,
        children   => $subscorers,
    );
