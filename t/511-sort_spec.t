...
package ReverseType;
use base qw( Search::Kino03::KinoSearch::FieldType::StringType );
...
sub test_sorted_search {
    ...
    while (@criteria) {
        ...
        push @rules,
            Search::Kino03::KinoSearch::Search::SortRule->new(
            field   => $field,
            reverse => $rev,
            );
    }
    push @rules, Search::Kino03::KinoSearch::Search::SortRule->new( type => 'doc_id' );
