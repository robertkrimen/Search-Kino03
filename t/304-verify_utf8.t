...
sub new {
    ...
    my $analyzer = Search::Kino03::KinoSearch::Analysis::Tokenizer->new( pattern => '\S+' );
    my $type
...
my $qparser = Search::Kino03::KinoSearch::QueryParser->new( schema => MySchema->new );
...
$term_query = Search::Kino03::KinoSearch::Search::TermQuery->new(
    field => 'content',
    term  => $smiley,
);
