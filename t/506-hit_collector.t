...
my $hc = Search::Kino03::KinoSearch::Search::HitCollector::SortCollector->new( wanted => 3 );
test_collect($hc);

my @got = map { $_->get_score } @{ $hc->pop_match_docs };
is_deeply( \@got, [ 2, 1, 0 ], "collect into HitQueue" );

$hc = Search::Kino03::KinoSearch::Search::HitCollector::SortCollector->new( wanted => 0 );
test_collect($hc);
...
$hc = Search::Kino03::KinoSearch::Search::HitCollector::BitCollector->new(
    bit_vector => $bit_vec );
test_collect($hc);
is_deeply(
    $bit_vec->to_arrayref,
...
$bit_vec = Search::Kino03::KinoSearch::Util::BitVector->new;
my $inner_coll = Search::Kino03::KinoSearch::Search::HitCollector::BitCollector->new(
    bit_vector => $bit_vec );
my $offset_coll = Search::Kino03::KinoSearch::Search::HitCollector::OffsetCollector->new(
...
sub test_collect {
    my $hc      = shift;
    my $matcher = Search::Kino03::KSx::Search::MockScorer->new(
        doc_ids => \@docs,
        scores  => \@scores,
    );
