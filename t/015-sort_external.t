...
$sortex = Search::Kino03::KinoSearch::Test::Util::BBSortEx->new( mem_thresh => 4 );
$sortex->feed( 'c', 1 );
...
my $run = Search::Kino03::KinoSearch::Test::Util::BBSortExRun->new(
...
$sortex = Search::Kino03::KinoSearch::Test::Util::BBSortEx->new;
@orig   = ( 'a' .. 'z' );
...
$sortex = Search::Kino03::KinoSearch::Test::Util::BBSortEx->new( mem_thresh => 30 );
@orig = 'a' .. 'z';
$sortex->feed($_) for ( shuffle(@orig) );
$sortex->flip;
while ( defined( my $result = $sortex->fetch ) ) {
...
$sortex = Search::Kino03::KinoSearch::Test::Util::BBSortEx->new( mem_thresh => 1 );
@orig = 'a' .. 'z';
$sortex->feed($_) for ( shuffle(@orig) );
$sortex->flip;
while ( defined( my $result = $sortex->fetch ) ) {
...
$sortex = Search::Kino03::KinoSearch::Test::Util::BBSortEx->new( mem_thresh => 20_000 );
...
sub to_bytebufs {
    my @bytebufs = map { Search::Kino03::KinoSearch::Util::ByteBuf->new($_) } @_;
    return \@bytebufs;
}
