...
package Search::Kino03::KSx::Index::ZlibDocReader;
use base qw( Search::Kino03::KinoSearch::Index::DocReader );
use Search::Kino03::KinoSearch::Util::StringHelper qw( utf8_valid utf8_flag_on );
...
sub fetch {
    ...
    return Search::Kino03::KinoSearch::Doc::HitDoc->new(
        fields => \%fields,
...
Search::Kino03::KSx::Index::ZlibDocReader - Compressed document storage.
