...
package Search::Kino03::KSx::Index::ByteBufDocWriter;
...
sub add_segment {
    ...
    confess("Not a ByteBufDocReader")
        ...
        and $doc_reader->isa("Search::Kino03::KSx::Index::ByteBufDocReader") );
...
Search::Kino03::KSx::Index::ByteBufDocWriter - Write a Doc as a fixed-width byte array.
