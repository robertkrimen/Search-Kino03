...
package Search::Kino03::KSx::Remote::SearchClient;
BEGIN { our @ISA = qw( Search::Kino03::KinoSearch::Search::Searchable ) }
use Carp;
...
Search::Kino03::KSx::Remote::SearchClient - Connect to a remote SearchServer.

=head1 SYNOPSIS

    my $client = Search::Kino03::KSx::Remote::SearchClient->new(
...
SearchClient is a subclass of L<Search::Kino03::KinoSearch::Search::Searchable> which can be
used to search an index on a remote machine made accessible via
L<SearchServer|Search::Kino03::KSx::Remote::SearchServer>.
