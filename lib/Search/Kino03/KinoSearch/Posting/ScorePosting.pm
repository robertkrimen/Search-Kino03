...
my $synopsis = <<'END_SYNOPSIS';
    ...
    # sub posting {
    #     my $self = shift;
    #     return Search::Kino03::KinoSearch::Posting::ScorePosting->new(@_);
    # }
END_SYNOPSIS

{   "Search::Kino03::KinoSearch::Posting::ScorePosting" => {
...
MODULE = Search::Kino03::KinoSearch   PACKAGE = Search::Kino03::KinoSearch::Posting::ScorePosting
