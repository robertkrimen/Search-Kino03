...
package Search::Kino03::KinoSearch::Test::TestUtils;
...
sub create_uscon_index {
    ...
    my $schema  = Search::Kino03::KinoSearch::Test::USConSchema->new;
    my $indexer = Search::Kino03::KinoSearch::Indexer->new(
        schema   => $schema,
        index    => $folder,
        truncate => 1,
...
sub test_analyzer {
    ...
    my $inversion = Search::Kino03::KinoSearch::Analysis::Inversion->new( text => $source );
...
MODULE = Search::Kino03::KinoSearch   PACKAGE = Search::Kino03::KinoSearch::Test::TestUtils
