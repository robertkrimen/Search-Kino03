...
MODULE = Search::Kino03::KinoSearch    PACKAGE = Search::Kino03::KinoSearch::Analysis::Token
...
CODE:
{
    ...
    HV *const args_hash    = XSBind_build_args_hash( &(ST(0)), 1, items,
            "Search::Kino03::KinoSearch::Analysis::Token::new_PARAMS");
...
Search::Kino03::KinoSearch::Analysis::Token - Redacted.
