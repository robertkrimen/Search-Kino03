...
MODULE = Search::Kino03::KinoSearch    PACKAGE = Search::Kino03::KinoSearch::Util::SortExternal
...
PPCODE:
{
    ...
    if (sv_derived_from(elem_sv, "Search::Kino03::KinoSearch::Obj")) {
        kino_Obj *elem;
...
{   "Search::Kino03::KinoSearch::Util::SortExternal" => {
        bind_methods =>
