...
Search::Kino03::KinoSearch::Docs::Cookbook::CustomQueryParser - Sample subclass of
QueryParser.

=head1 ABSTRACT

Implement a custom search query language using Search::Kino03::KinoSearch::QueryParser and
Parse::RecDescent.
...
PolyAnalyzer.
    ...
    use Search::Kino03::KinoSearch::Search::PhraseQuery;
    use Search::Kino03::KinoSearch::Search::ORQuery;
    use Carp;
...
help keep the size of our main parse() subroutine down:
    ...
    sub _make_term_query {
        my ( $self, $term ) = @_;
        return Search::Kino03::KinoSearch::Search::TermQuery->new(
            field => $self->{field},
            term  => $term,
        );
    }
    ...
    sub _make_phrase_query {
        my ( $self, $terms ) = @_;
        return Search::Kino03::KinoSearch::Search::PhraseQuery->new(
            field => $self->{field},
            terms => $terms,
        );
    }
...
ORQuery.
    ...
    sub parse {
        ...
        my $or_query = Search::Kino03::KinoSearch::Search::ORQuery->new;
...
Search::Kino03::KinoSearch::QueryParser and take advantage of some of its existing methods.
...
this time -- Search::Kino03::KinoSearch::QueryParser's constructor requires a Schema which
conveys field and Analyzer information, so we can just defer to that.
    ...
    use Search::Kino03::KinoSearch::Search::PhraseQuery;
    use Search::Kino03::KinoSearch::Search::ORQuery;
    use Search::Kino03::KinoSearch::Search::NoMatchQuery;
    use PrefixQuery;
...
production which joins the leaves together with an ORQuery.
    ...
    tree:
        leaf_queries
        { 
            $return = Search::Kino03::KinoSearch::Search::ORQuery->new;
    ...
    term_query:
        /(\S+)/
        { Search::Kino03::KinoSearch::Search::LeafQuery->new( text => $1 ) }
    ...
    sub parse {
        ...
        Search::Kino03::KinoSearch::Search::NoMatchQuery->new;
    }
...
The magic happens in Search::Kino03::KinoSearch::QueryParser's expand() method, which walks
